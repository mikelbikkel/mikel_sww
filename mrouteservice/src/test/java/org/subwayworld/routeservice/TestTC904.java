 ...
 * 
 */
public class TestTC904 extends TestBase {
  ...
  public void testAG() throws RSException {
    ...
    rr.reset();
    rt = m_rs.getRoute("904A", "904G", null, rr);
    assertFalse(null == rt);
  ...
  public void testGA() throws RSException {
    ...
    List<RouteSegment> rt = null;
    rr.reset();
    rt = m_rs.getRoute("904G", "904A", null, rr);
    assertFalse(null == rt);
    assertFalse(rt.isEmpty());
    // assertTrue(3 == rt.size());
    assertTrue(RCODE.OK == rr.getCode());
  ...
  public void testAD() throws RSException {
    ...
    List<RouteSegment> rt = null;
    rr.reset();
    rt = m_rs.getRoute("904A", "904D", null, rr);
    assertFalse(null == rt);
    assertFalse(rt.isEmpty());
    // assertTrue(3 == rt.size());
    assertTrue(RCODE.OK == rr.getCode());
  ...
  public void testAE() throws RSException {
    ...
    List<RouteSegment> rt = null;
    rr.reset();
    rt = m_rs.getRoute("904A", "904E", null, rr);
    assertFalse(null == rt);
    assertFalse(rt.isEmpty());
    // assertTrue(3 == rt.size());
    assertTrue(RCODE.OK == rr.getCode());
